...
const profileFormSchema = z.object({
  ...
  username: z.string()
    ...
    .regex(/^[a-z0-9_.]+$/, { message: "Use apenas letras minúsculas, números, '_' ou '.'." }),
  bio: z.string()
  ...
  const { mutate: editProfileMutation, isPending } = useMutation({
    mutationFn: async (data: ProfileFormData) => {
      ...
      if (data.avatar && data.avatar.length > 0) {
        console.log("Adicionando arquivo de avatar ao FormData...", data.avatar[0]);
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl><Input placeholder="Seu sobrenome" {...field} /></FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              />
